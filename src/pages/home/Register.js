                                    ...
                                    <Grid container spacing={2}>
                                        ...
                                        <Grid item xs={12}>
                                            <TextInputField
                                                ref={fullNameInput}
                                                required={true}
                                                label={selectedValue === "School" ? "School Name" : "Full Name"}
                                                onChange={(value) => setFullName(value)}
                                            />
                                        </Grid>
                                        {selectedValue !== "School" && <Grid item xs={12}>
                                            <SelectInputField
                                                ref={genderInput}
                                                label={"Gender"}
                                                required={true}
                                        ...
                                        {selectedValue === "Student" && <Grid item xs={12}>
                                            <SelectInputField
                                        ...
                                        <Grid item xs={12}>
                                            <TextInputField
                                                ref={phoneInput}
                                                required={true}
                                                label={selectedValue === "School" ? "Contact Phone" : "Phone"}
