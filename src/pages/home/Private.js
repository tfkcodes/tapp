    ...
    return (
        <OtherLayout user={user}>
            <Routes>
                ...
                <Route exact={true} path={"/courses-details/:courseId"}
                ...
                <Route exact={true} path={"/students"}
                       element={<Students/>}/>
                <Route exact={true} path={"students/details/:id/*"}
                       element={<StudentDetails/>}/>
                <Route exact={true} path={"employee"}
                       element={<Employee/>}/>
                <Route exact={true} path={"employee/details/:id/*"}
                       element={<EditEmployee/>}/>
                <Route exact={true} path={"/configuration/*"}
